        ...
        switch(this.id) {
            case "1":
                return {
                    ...
                    text: "Скандинавский стиль появился в Северной Европе и распространился по миру благодаря компании IKEA. Он сдержанный и в то же время уютный. В основе стиля лежит скандинавская философия хюгге. Хюгге — это ощущение уюта, теплое чувство физического и духовного комфорта. "
                };
            case "2":
                return {
                    id: 2,
            ...
            case "3":
                return {
                    ...
                    title: "Джапанди",
                    text: "Джапанди появился сравнительно недавно как симбиоз скандинавского и японского стилей. Он сочетает в себе минималистичные черты и натуральные текстуры японского и простоту скандинавского стиля. "    
                };
            default:
                return {
                    id: this.id,
